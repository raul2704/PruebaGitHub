...
namespace PruebaGitHub
{
    public partial class DBPickiuEntities 
    {
        public List<cgestionarpickiu> Lista_Pickiu()
        {
            ...
            {
              lista.Add(new cgestionarpickiu { NoVuelo = pk.Guias.Vuelos.NoVuelo.ToString(), FechaVuelo = pk.Guias.Vuelos.Fecha, Ciudad = pk.Guias.Vuelos.Ciudades.Nombre, NoGuia = pk.Guias.numero.ToString()});
            }
            return lista;
        }
    }
